...
class HostListOperationAdapter(val data:List<String>, private val selectedData:List<String>)
    ...
    class ViewHolder(val binding:OperationHostItemBinding): RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, position: Int): ViewHolder {
        return ViewHolder(OperationHostItemBinding.inflate(LayoutInflater.from(parent.context) , parent , false))
    }
